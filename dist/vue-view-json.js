import { defineComponent as k, createVNode as u, reactive as N, Fragment as q } from "vue";
function w(t) {
...
const v = /* @__PURE__ */ k({
  ...
  setup(t, {
    ...
    const h = N({
      // 关闭状态的路径
      closedPath: {}
    }), V = (e) => t.deep ? e.split("[").length >= t.deep : !1, C = (e, n) => {
      ...
      class: ["node-key"]
    }, [`${t.showDoubleQuotes && '"'}${e}${t.showDoubleQuotes && '"'}:  `]), I = ({
      key: e,
      data: n,
      level: o,
      showComma: l,
      ...
      defaultKey: g(e)
    }) : g(e), $ = (e) => (e === null ? e = "null" : e === void 0 && (e = "undefined"), w(e) === "string" ? `${m(e) ? "" : t.showDoubleQuotes && '"'}${e}${m(e) ? "" : t.showDoubleQuotes && '"'}` : e + ""), L = ({
      key: e,
      data: n,
      level: o,
      showComma: l,
      ...
      const c = h.closedPath[r] === void 0 ? V(r) : h.closedPath[r];
      let s = 0;
      if (P(n)) {
        const d = n.length;
        return c && (s = d), u("div", {
